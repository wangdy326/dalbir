var $path_base = "/";
var grid_data = "#{@departments.to_json}";
var state_list = "";

jQuery(function($) {
  var grid_selector = "#departments-table";
  var pager_selector = "#departments-pager";
  ...
  jQuery(grid_selector).jqGrid({
    ...
    datatype: "local",
    height: 250,
    colNames:[' ', 'Department','Buyer','Asst. Buyer','ICS'],
    colModel:[
      {
      ...
      {name:'buyer',index:'Buyer',width:60,editable: true,editoptions:{size:"20",maxlength:"30"}},
      {name:'asst_buyer',index:'Asst. Buyer', width:60,editable: true,editoptions:{size:"20",maxlength:"30"}},
      {name:'ics',index:'ICS', width:60,editable: true,editoptions:{size:"20",maxlength:"30"}},
    ],
    ...
    editurl: $path_base+"departments/jqedit",//nothing is saved
